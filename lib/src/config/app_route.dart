...
import 'package:footballapp/home_selection.dart';
...
import '../features/soccer/presentation/screens/onboarding.dart';
...
class Routes {
  ...
  static const String onBoarding = "OnBoardingAnimationExample";
  static const String homePageSelection = "HomePageSelection";
}
  ...
  static Route routesGenerator(RouteSettings settings) {
    switch (settings.name) {
      ...
      case Routes.onBoarding:
        return MaterialPageRoute(
            builder: (context) => const OnBoardingAnimationExample());
      case Routes.homePageSelection:
        return MaterialPageRoute(
            builder: (context) =>  HomePageSelection());
    }
