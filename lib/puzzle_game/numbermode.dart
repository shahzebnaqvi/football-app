...
class _NumberModeState extends State<NumberMode>
  ...
  late Color _medium = AppColors.red, _complement = Colors.white;
  ...
  final List<Color> _secondaryColors = <Color>[
    HSLColor.fromColor(Colors.redAccent.shade400)
        .withLightness(
            HSLColor.fromColor(Colors.redAccent.shade400).lightness * (0.85))
        .toColor(),
    HSLColor.fromColor(Colors.blueAccent.shade400)
        .withLightness(
            HSLColor.fromColor(Colors.blueAccent.shade400).lightness * (0.85))
        .toColor(),
    ...
    HSLColor.fromColor(Colors.pinkAccent.shade400)
        .withLightness(
            HSLColor.fromColor(Colors.pinkAccent.shade400).lightness * (0.85))
        .toColor(),
    HSLColor.fromColor(Colors.purpleAccent.shade400)
        .withLightness(
            HSLColor.fromColor(Colors.purpleAccent.shade400).lightness * (0.85))
        .toColor(),
    HSLColor.fromColor(Colors.greenAccent.shade400)
        .withLightness(
            HSLColor.fromColor(Colors.greenAccent.shade400).lightness * (0.85))
        .toColor(),
    HSLColor.fromColor(Colors.tealAccent.shade400)
        .withLightness(
            HSLColor.fromColor(Colors.tealAccent.shade400).lightness * (0.85))
        .toColor(),
  ...
  void _changeTheme() async {
    if (_opacity == 1.0) {
      ...
      showGeneralDialog(
        barrierDismissible: true,
        barrierLabel: '',
        barrierColor: (_medium == AppColors.red)
    ...
    if (_opacity == 1.0) {
      ...
      setState(() {
        _medium = (_medium == AppColors.red)
            ...
            : AppColors.red;
        _complement =
            (_complement == Colors.white) ? AppColors.red : Colors.white;
      });
    }
  }
      ...
      children: <Widget>[
          ...
          child: Container(
            decoration: BoxDecoration(
              gradient: LinearGradient(
                ...
                colors: (_medium == AppColors.red)
                    ? <Color>[
                        HSLColor.fromColor(AppColors.red)
                            .withLightness(
                                HSLColor.fromColor(AppColors.red)
                                        .lightness *
                                    (1.15))
        ...
        RepaintBoundary(
          ...
          child: WillPopScope(
            ...
            child: Scaffold(
              ...
              appBar: AppBar(
                ...
                systemOverlayStyle: (_medium == AppColors.red)
                                ...
                                if (snapshot.hasData) {
                                  return Text(
                                    ...
                                    style: TextStyle(
                                      ...
                                      color: _complement,
                                      fontWeight: FontWeight.w600,
                                      // Shadows and other styles...
                                    ),
                                  );
                                } else {
                                  // Handle the case when data is not available
                                  return Text(
                                    '00:00', // Or any default value you want to show
                                    textAlign: TextAlign.center,
                                    style: TextStyle(
                                      fontSize: _textFontSize / 2.5,
                                      color: _complement,
          ...
          image: DecorationImage(
            ...
            colorFilter: ColorFilter.mode(Colors.black.withOpacity(0.2), BlendMode.dstATop), // Adjust opacity here
